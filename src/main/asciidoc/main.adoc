ifndef::imagesoutdir[:imagesoutdir: ../../../target/asciidoc/images]
ifndef::imagesdir[:imagesdir: ../../../target/asciidoc/images]
ifndef::srcmainjavadir[:srcmainjavadir: ../java]
ifndef::srctestjavadir[:srctestjavadir: ../../test/java]
The Article Title
=================
